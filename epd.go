...
// EPD2in9 is the config for the 2.9 inch display.
var EPD2in9 = Opts{
	W: 128,
	H: 296,
	FullUpdate: LUT{
		0x32, 0x02, 0x02, 0x01, 0x11, 0x12, 0x12, 0x22,
		0x22, 0x66, 0x69, 0x69, 0x59, 0x58, 0x99, 0x99,
		0x88, 0x00, 0x00, 0x00, 0x00, 0xF8, 0xB4, 0x13,
		0x51, 0x35, 0x51, 0x51, 0x19, 0x01, 0x00,
	},
	PartialUpdate: LUT{
		0x32, 0x10, 0x18, 0x18, 0x08, 0x18, 0x18, 0x08,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x13, 0x14, 0x44,
...
func (d *Dev) setLut() error {
	lut := d.opts.FullUpdate

	d.update = d.opts.Update
	if d.update == Partial {
